  ...
  return (
    <main>
      <section className="catalog-hero">
        <div>
          {/* <p className="eyebrow">Shop / Fragrances</p> */}
        <h1><LineReveal>Choose the air you leave behind.</LineReveal></h1></div>
        <Reveal className="catalog-intro"><p className="body-copy muted">Rimara is built around moments, not moods invented in a lab. Each fragrance begins with a time, a temperature and a feeling you recognize.</p>
        <br></br><p className="body-copy muted">From deep oud at 02:00 to soft floral before dawn, this collection helps you find the scent that feels closest to who you are — and what you want to leave in the air.</p></Reveal>
      </section>
