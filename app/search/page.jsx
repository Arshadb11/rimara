...
export default function SearchPage() {
  ...
  return <main>
    ...
    {results.length ? <div className="product-grid search-results">{results.map((product) => <div key={product.id} product={product} ></div>)}</div> : <section className="empty-state"><h2>No fragrance found.</h2><p>Try oud, floral, fresh, amber, woody or a product name.</p></section>}
  </main>;
}
